...
public class WhenCreatingObjects {
    ...
    public void creating_a_cat() {
        ...
        com.serenitydojo.Cat felix = new com.serenitydojo.Cat("Felix", "Tuna" , 4); //Cat() is a constructor, it is like a special method that creates an object
...
//        felix.setName("Felix");
        ...
        com.serenitydojo.Cat spot = new com.serenitydojo.Cat("Spot" , "Tuna" , 3);
//        spot.age = 3;
    ...
    public void creating_a_dog() {
        com.serenitydojo.Dog fido = new Dog("Fido" , "Bone" , 5);
    ...
    public void cat_makes_noise() {
        ...
        com.serenitydojo.Cat felix = new com.serenitydojo.Cat("Felix" , 4);
        com.serenitydojo.Cat spot = new Cat("Spot" , "Salmon", 3);
